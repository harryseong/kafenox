...
struct ScanningView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            // Two never-ending animations -- exactly what Reduce Motion is
            // for. Both render fine held still.
    ...
    private var scanningState: some View {
        VStack(spacing: 24) {
            ZStack {
                ...
                // Purely decorative; a frozen sweep line just looks broken.
                if !reduceMotion {
                    Rectangle()
                        .fill(
            ...
            HStack(spacing: 10) {
                Circle()
                    ...
                    .overlay(
                        Circle()
                            // A stopped quarter-arc reads as a rendering bug;
                            // a full ring reads as a deliberate indicator.
